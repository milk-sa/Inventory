...
class Sale(models.Model):
    ...
    unit_price_at_sale = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
...
class EmployeeProfile(models.Model):
    ...
    phone = models.CharField(max_length=20, blank=True)
    address = models.TextField(blank=True)
    is_employee = models.BooleanField(default=True)  # Flag to distinguish from admin
